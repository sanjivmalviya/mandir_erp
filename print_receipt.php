        ...
        <div class="col-md-6 col-sm-12 col-xs-12 box" style="border: 1px solid;padding: 0;border-radius: 5px;">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12" style="padding: 0;">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12" style="padding-left: 10px;padding-top: 10px;">
                    <p style="letter-spacing: 0.4px;line-height: 25px;">Received with thanks from <span style="font-weight: bold;"><?php echo $student_name; ?></span> the sum of Rupees <b><?php echo $fee_amount; ?> Only</b> for Std. <?php echo "<b>".$standards[$student_standard]."</b>"; if($student_standard == 11 || $student_standard == 12){ echo " ".$streams[$student_stream]; } if($student_stream == 2){ echo "(".$subjects[$student_subject].")"; } ?> in Payment by <?php echo $mode; ?> </p> 
                </div>
